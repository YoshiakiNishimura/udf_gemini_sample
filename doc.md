...
![BLOB処理の流れ](images/05_blob_1280x720.png)
...
このJavaプログラムでは、次の処理を行います。

1. 接続先エンドポイントとPNGファイルパスを受け取る
1. BLOB列を持つテーブルを作成する
1. PNGファイルを`TgBlob`としてINSERTする
...
![proto定義で広がるUDFの表現](images/06_udf_1280x720.png)
